...
public class MyWebsite
{
		...
		public static final By LOC_BTN_SENDMESSAGEBUTTON = By.xpath("/html/body/my-app/sqs-component/div/button[1]");
		public static final By LOC_BTN_RECEIVEMESSAGEBUTTON = By.xpath("/html/body/my-app/sqs-component/div/button[2]");	
